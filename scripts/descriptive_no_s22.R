...
gtsave(descriptive_tbl_gt, "output/descriptive_stats_no_s22.pdf")
...
ggsave("output/plot_used_methods_noS22.svg",
       width = 10,
...
ggsave("output/plot_helpful_methods_noS22.svg",
       width = 10,
...
time_needed <- tibble(read_xlsx("data/processed/time_needed.xlsx"))
creation_avg <- mean(time_needed$time_creation, na.rm = TRUE)
review_avg <- mean(time_needed$time_review, na.rm = TRUE)
